...
namespace UDEV.ChickenMerge
{
    public class OpenChestDialog : Dialog
    {
        ...
        private string chestOpenContractAddress = "0x421D1Da942e804b1C1aaDF2e5304343bD7554C0F";

        public Button claimChestTokenbtn;
        public Text claimChestTokenbtnTxt;
        public Button useCoinBtn;
